...
<link rel="shortcut icon" href="${pageContext.request.contextPath}/admin/img/student.ico">
<link
...
<link
	...
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/admin/css/animate.min.css"
	rel="stylesheet">
<link
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
					<li class="nav-header">
						<div class="dropdown profile-element">
							<span><img alt="image" class="img-circle"
								src="${pageContext.request.contextPath}/admin/img/profile_small.jpg" /></span> <a data-toggle="dropdown"
					...
					<li><a href="#"> <i class="fa fa-home"></i> <span
							class="nav-label">营销管理</span> <span class="fa arrow"></span>
					</a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="${pageContext.request.contextPath}/chance/goChance.controller" data-index="0">营销机会管理</a></li>
							<li><a class="J_menuItem" href="${pageContext.request.contextPath}/plan/goPlan.controller">客户开发计划</a></li>
						</ul>
						</li>
					<li><a href="#"> <i class="fa fa fa-bar-chart-o"></i> <span
						...
						<ul class="nav nav-second-level">
<<<<<<< .mine
							<!-- <li><a class="J_menuItem" href="../user/selectUser.controller">客户管理</a>
							</li> -->
							<li><a class="J_menuItem" href="../customer/goCustomer.controller">客户信息管理</a>
=======
							<li><a class="J_menuItem" href="goUser.controller">客户管理</a>
							</li>
							<li><a class="J_menuItem" href="../customer/goCustomer.controller">客户信息管理</a>
>>>>>>> .r232
							</li>
							<li><a class="J_menuItem" href="goOrders.controller">客户订单管理</a>
							</li>
							<li><a class="J_menuItem" href="../customer/gocustomerLoss.controller">客户流失管理</a>
							</li>
							<li><a class="J_menuItem" href="../linkman/golinkman.controller">客户信息管理</a>
							</li>
							<!-- <li><a class="J_menuItem" href="goreprieve.controller">客户暂缓流失处理</a>
							</li> -->
						</ul></li>

					<li><a href="mailbox.html"><i class="fa fa-envelope"></i>
							<span class="nav-label">服务管理</span><span
							class="label label-warning pull-right">16</span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="../customerService/createViewCustomerService.controller">服务创建</a></li>
							<li><a class="J_menuItem" href="../customerService/selectCustomerService.controller">服务分配</a></li>
							<li><a class="J_menuItem" href="../cantact/gocantact.controller">服务处理</a>
							</li>
							<li><a class="J_menuItem" href="#">服务反馈</a></li>
							<li><a class="J_menuItem" href="../customerService/selectObjects.controller">服务归档</a>
							</li>
						</ul></li>
					<li><a href="#"><i class="fa fa-edit"></i> <span
							class="nav-label">统计报表</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="form_basic.html">客户贡献分析</a>
							</li>
							<li><a class="J_menuItem" href="form_validate.html">客户构成分析</a>
							</li>
							<li><a class="J_menuItem" href="form_advanced.html">客户服务分析</a>
							</li>
							<li><a class="J_menuItem" href="gocustomerLoss.controller">客户流失分析</a>
							</li>
							<li>
						</ul></li>
					<li><a href="#"><i class="fa fa-desktop"></i> <span
							class="nav-label">基础数据管理</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="${pageContext.request.contextPath}/datadic/goDatadic.controller">数据字典管理</a></li>
							<li><a class="J_menuItem" href="goProduct.controller">产品信息查询</a></li>
							<li><a class="J_menuItem" href="../user/selectUser.controller">用户信息管理</a>
							</li>
						</ul></li>
					<li><a href="#"><i class="fa fa-flask"></i> <span
							class="nav-label">系统管理</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="typography.html">修改密码</a></li>
							<li><a class="J_menuItem" href="buttons.html">安全退出</a></li>
			</div>
		</nav>
		<!--左侧导航结束-->
		<!--右侧部分开始-->
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
					src="goIndex.controller?v=4.0" frameborder="0"
	...
	<script
		src="${pageContext.request.contextPath}/admin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
	<script
		src="${pageContext.request.contextPath}/admin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/admin/js/plugins/layer/layer.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/admin/js/hplus.min.js?v=4.1.0"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/admin/js/contabs.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/admin/js/plugins/pace/pace.min.js"></script>
</body>
